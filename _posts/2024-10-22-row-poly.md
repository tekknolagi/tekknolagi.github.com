...
adapted for Standard ML and the ML-family languages). River and I [wrote about
it](/blog/type-inference) earlier this month. Check out that post if you would
like an introduction or refresher. In this post, we'll add *row polymorphism*
to it. We'll do it in the context of Algorithm J, but the core ideas should be
