...
In 2007, Nguyen and Scholz publish [Computing SSA Form with
Matrices](/assets/img/ssa-matrices.pdf) (PDF) which computes all the
dominance-based stuff using boolean matrices. Wild! I wonder if anyone has
ported it to a GPU.
...
In 2026, Leissa and Griebler write [SSA without Dominance for Higher-Order
Programs](/assets/img/ssa-without-dominance.pdf) (PDF), which I have yet to
read...
...
* [The LibFIRM paper](/assets/img/firm-ssa.pdf)
...
* [Linear Scan Register Allocation on SSA Form](/assets/img/wimmer-linear-scan-ssa.pdf)
...
**Update:** I have now written some blog posts about linear scan register
allocation directly on SSA:

* [Linear scan register allocation on SSA](/blog/linear-scan/)
* [Linear scan with lifetime holes](/blog/linear-scan-lifetime-holes/)
...
* trace based register allocation (on full CFG)
  * [S6 implementation](https://github.com/google-deepmind/s6/blob/69cac9c981fbd3217ed117c3898382cfe094efc0/src/code_generation/trace_register_allocator.h)
