...
and could be further segmented into `GC`, `Thread`, etc. For example, V8's old
Hydrogen IR has [some heap locations][hydrogen] like ArrayElements, ArrayLengths,
StringLengths, and InobjectFields.

[hydrogen]: https://github.com/tekknolagi/v8/blob/f030838700a83cde6992cb8ebcb3facc6a8fc1f1/src/crankshaft/hydrogen-store-elimination.cc#L20
...
language](https://blog.regehr.org/archives/959). Somewhere in your IR there
...
See the [full code](https://github.com/tekknolagi/tekknolagi.github.com/blob/67a1c5cbcf81d96cc63f8b3904619c018d1f2be1/loadstore.py).
...
checks](https://wingolog.org/archives/2026/02/18/two-mechanisms-for-dynamic-type-checks)
