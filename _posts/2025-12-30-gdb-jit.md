...
`__jit_debug_descriptor`. It automatically adds its own internal breakpoints at
this function, if it exists. Then, when you compile code, you call this
function from your runtime. This gives GDB control of the process so it can
...
1. Generate an *entire* ELF/Mach-O/... object in-memory (!) for that one function
...
1. Call `__jit_debug_register_code`
