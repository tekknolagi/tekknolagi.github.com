...
<!-- TODO cite C1 2006 paper -->
defining instruction[^hotspot-c1]; alternately, a variable and its defining instruction are
addressed by the same name. The previous example is not valid SSA; `x` has two
definitions.

[^hotspot-c1]: I first saw this for real in CF Bolz-Tereick's [toy optimizer]
    series about tracing JITs and it completely changed how I think about IRs.
    Then, when reading about register allocation, I saw this in Section 2 of
    [Design of the Java HotSpot&trade; Client Compiler for Java
    6][hotspot-client] (PDF).

[toy optimizer]: https://pypy.org/posts/2022/07/toy-optimizer.html
[hotspot-client]: /assets/img/design-hotspot-client-compiler.pdf
...
* Some papers and posts I found myself agreeing with
  ...
  * [Design of the Java HotSpot&trade; Client Compiler for Java 6][hotspot-client] (PDF)
