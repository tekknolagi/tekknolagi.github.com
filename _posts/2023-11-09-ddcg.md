...
but now you have to turn virtual registers into machine registers.
...
I also wonder if this can be applied to SSA IRs that have phi nodes. I've never
written a pass to lower from SSA, but I've heard the parallel copy is really
hard to get right.
