...
After talking with [Andy Chu][https://andychu.net/] of [Oil
Shell][https://www.oilshell.org/] fame (whose name is the first that comes to
mind when I think of precedence parsing) and some faffing about, I think I
figured out a neat enough API for this.
