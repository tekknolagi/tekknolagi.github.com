...
WebAssembly module. It gives you, the programmer, hooks to set up some memory
before turning the running state back into a WebAssembly module. This is
generally pretty helpful, but in our case it's going to be *extremely* helpful
in bundling the program with the interpreter. But this is all kind of handwavy,
