...
In this case, our *may alias* is if the offsets overlap. This means that the
...
The boolean logic looks a little weird, maybe. But we can also rewrite (via
DeMorgan's law) as:
...
and by type not to alias.

Then our test passes!
...
* If we know at compile-time that object A has 5 at offset 0 and object B has 7
  at offset 0, they don't alias (thanks, CF)
* ...
